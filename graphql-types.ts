...
export type AirtableDataFromArgs = {
  formatString?: Maybe<Scalars['String']>;
  fromNow?: Maybe<Scalars['Boolean']>;
  difference?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
...
export type AirtableDataToArgs = {
  formatString?: Maybe<Scalars['String']>;
  fromNow?: Maybe<Scalars['Boolean']>;
  difference?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
...
export type AirtableFieldFieldsEnum = 
  ...
  | 'internal___type'
  | 'localFiles'
  | 'localFiles___sourceInstanceName'
  | 'localFiles___absolutePath'
  | 'localFiles___relativePath'
  | 'localFiles___extension'
  | 'localFiles___size'
  | 'localFiles___prettySize'
  | 'localFiles___modifiedTime'
  | 'localFiles___accessTime'
  | 'localFiles___changeTime'
  | 'localFiles___birthTime'
  | 'localFiles___root'
  | 'localFiles___dir'
  | 'localFiles___base'
  | 'localFiles___ext'
  | 'localFiles___name'
  | 'localFiles___relativeDirectory'
  | 'localFiles___dev'
  | 'localFiles___mode'
  | 'localFiles___nlink'
  | 'localFiles___uid'
  ...
  | 'localFiles___rdev'
  | 'localFiles___ino'
  | 'localFiles___atimeMs'
  | 'localFiles___mtimeMs'
  | 'localFiles___ctimeMs'
  | 'localFiles___atime'
  | 'localFiles___mtime'
  | 'localFiles___ctime'
  | 'localFiles___birthtime'
  | 'localFiles___birthtimeMs'
  | 'localFiles___blksize'
  | 'localFiles___blocks'
  | 'localFiles___url'
  | 'localFiles___publicURL'
  | 'localFiles___childImageSharp___fixed___base64'
  | 'localFiles___childImageSharp___fixed___tracedSVG'
  | 'localFiles___childImageSharp___fixed___aspectRatio'
  | 'localFiles___childImageSharp___fixed___width'
  | 'localFiles___childImageSharp___fixed___height'
  | 'localFiles___childImageSharp___fixed___src'
  | 'localFiles___childImageSharp___fixed___srcSet'
  | 'localFiles___childImageSharp___fixed___srcWebp'
  | 'localFiles___childImageSharp___fixed___srcSetWebp'
  | 'localFiles___childImageSharp___fixed___originalName'
  | 'localFiles___childImageSharp___resolutions___base64'
  | 'localFiles___childImageSharp___resolutions___tracedSVG'
  | 'localFiles___childImageSharp___resolutions___aspectRatio'
  | 'localFiles___childImageSharp___resolutions___width'
  | 'localFiles___childImageSharp___resolutions___height'
  | 'localFiles___childImageSharp___resolutions___src'
  | 'localFiles___childImageSharp___resolutions___srcSet'
  | 'localFiles___childImageSharp___resolutions___srcWebp'
  | 'localFiles___childImageSharp___resolutions___srcSetWebp'
  | 'localFiles___childImageSharp___resolutions___originalName'
  | 'localFiles___childImageSharp___fluid___base64'
  | 'localFiles___childImageSharp___fluid___tracedSVG'
  | 'localFiles___childImageSharp___fluid___aspectRatio'
  | 'localFiles___childImageSharp___fluid___src'
  | 'localFiles___childImageSharp___fluid___srcSet'
  | 'localFiles___childImageSharp___fluid___srcWebp'
  | 'localFiles___childImageSharp___fluid___srcSetWebp'
  | 'localFiles___childImageSharp___fluid___sizes'
  | 'localFiles___childImageSharp___fluid___originalImg'
  | 'localFiles___childImageSharp___fluid___originalName'
  | 'localFiles___childImageSharp___fluid___presentationWidth'
  | 'localFiles___childImageSharp___fluid___presentationHeight'
  | 'localFiles___childImageSharp___sizes___base64'
  | 'localFiles___childImageSharp___sizes___tracedSVG'
  | 'localFiles___childImageSharp___sizes___aspectRatio'
  | 'localFiles___childImageSharp___sizes___src'
  | 'localFiles___childImageSharp___sizes___srcSet'
  | 'localFiles___childImageSharp___sizes___srcWebp'
  | 'localFiles___childImageSharp___sizes___srcSetWebp'
  | 'localFiles___childImageSharp___sizes___sizes'
  | 'localFiles___childImageSharp___sizes___originalImg'
  | 'localFiles___childImageSharp___sizes___originalName'
  | 'localFiles___childImageSharp___sizes___presentationWidth'
  | 'localFiles___childImageSharp___sizes___presentationHeight'
  | 'localFiles___childImageSharp___original___width'
  | 'localFiles___childImageSharp___original___height'
  | 'localFiles___childImageSharp___original___src'
  | 'localFiles___childImageSharp___resize___src'
  | 'localFiles___childImageSharp___resize___tracedSVG'
  | 'localFiles___childImageSharp___resize___width'
  | 'localFiles___childImageSharp___resize___height'
  | 'localFiles___childImageSharp___resize___aspectRatio'
  | 'localFiles___childImageSharp___resize___originalName'
  | 'localFiles___childImageSharp___id'
  | 'localFiles___childImageSharp___parent___id'
  | 'localFiles___childImageSharp___parent___children'
  | 'localFiles___childImageSharp___children'
  | 'localFiles___childImageSharp___children___id'
  | 'localFiles___childImageSharp___children___children'
  | 'localFiles___childImageSharp___internal___content'
  | 'localFiles___childImageSharp___internal___contentDigest'
  | 'localFiles___childImageSharp___internal___description'
  | 'localFiles___childImageSharp___internal___fieldOwners'
  | 'localFiles___childImageSharp___internal___ignoreType'
  | 'localFiles___childImageSharp___internal___mediaType'
  | 'localFiles___childImageSharp___internal___owner'
  | 'localFiles___childImageSharp___internal___type'
  | 'localFiles___id'
  | 'localFiles___parent___id'
  | 'localFiles___parent___parent___id'
  | 'localFiles___parent___parent___children'
  | 'localFiles___parent___children'
  | 'localFiles___parent___children___id'
  | 'localFiles___parent___children___children'
  | 'localFiles___parent___internal___content'
  | 'localFiles___parent___internal___contentDigest'
  | 'localFiles___parent___internal___description'
  | 'localFiles___parent___internal___fieldOwners'
  | 'localFiles___parent___internal___ignoreType'
  | 'localFiles___parent___internal___mediaType'
  | 'localFiles___parent___internal___owner'
  | 'localFiles___parent___internal___type'
  | 'localFiles___children'
  | 'localFiles___children___id'
  | 'localFiles___children___parent___id'
  | 'localFiles___children___parent___children'
  | 'localFiles___children___children'
  | 'localFiles___children___children___id'
  | 'localFiles___children___children___children'
  | 'localFiles___children___internal___content'
  | 'localFiles___children___internal___contentDigest'
  | 'localFiles___children___internal___description'
  | 'localFiles___children___internal___fieldOwners'
  | 'localFiles___children___internal___ignoreType'
  | 'localFiles___children___internal___mediaType'
  | 'localFiles___children___internal___owner'
  | 'localFiles___children___internal___type'
  | 'localFiles___internal___content'
  | 'localFiles___internal___contentDigest'
  | 'localFiles___internal___description'
  | 'localFiles___internal___fieldOwners'
  | 'localFiles___internal___ignoreType'
  | 'localFiles___internal___mediaType'
  | 'localFiles___internal___owner'
  | 'localFiles___internal___type'
...
export type AirtableFieldsEnum = 
  ...
  | 'data___organisation___parent___id'
  | 'data___organisation___parent___children'
  | 'data___organisation___children'
  | 'data___organisation___children___id'
  | 'data___organisation___children___children'
  | 'data___organisation___internal___content'
  | 'data___organisation___internal___contentDigest'
  | 'data___organisation___internal___description'
  | 'data___organisation___internal___fieldOwners'
  | 'data___organisation___internal___ignoreType'
  | 'data___organisation___internal___mediaType'
  | 'data___organisation___internal___owner'
  | 'data___organisation___internal___type'
  ...
  | 'data___text_en___localFiles'
  | 'data___text_en___localFiles___sourceInstanceName'
  | 'data___text_en___localFiles___absolutePath'
  | 'data___text_en___localFiles___relativePath'
  | 'data___text_en___localFiles___extension'
  | 'data___text_en___localFiles___size'
  | 'data___text_en___localFiles___prettySize'
  | 'data___text_en___localFiles___modifiedTime'
  | 'data___text_en___localFiles___accessTime'
  | 'data___text_en___localFiles___changeTime'
  | 'data___text_en___localFiles___birthTime'
  | 'data___text_en___localFiles___root'
  | 'data___text_en___localFiles___dir'
  | 'data___text_en___localFiles___base'
  | 'data___text_en___localFiles___ext'
  | 'data___text_en___localFiles___name'
  | 'data___text_en___localFiles___relativeDirectory'
  | 'data___text_en___localFiles___dev'
  | 'data___text_en___localFiles___mode'
  | 'data___text_en___localFiles___nlink'
  | 'data___text_en___localFiles___uid'
  | 'data___text_en___localFiles___gid'
  | 'data___text_en___localFiles___rdev'
  | 'data___text_en___localFiles___ino'
  | 'data___text_en___localFiles___atimeMs'
  | 'data___text_en___localFiles___mtimeMs'
  | 'data___text_en___localFiles___ctimeMs'
  | 'data___text_en___localFiles___atime'
  | 'data___text_en___localFiles___mtime'
  | 'data___text_en___localFiles___ctime'
  | 'data___text_en___localFiles___birthtime'
  | 'data___text_en___localFiles___birthtimeMs'
  | 'data___text_en___localFiles___blksize'
  | 'data___text_en___localFiles___blocks'
  | 'data___text_en___localFiles___url'
  | 'data___text_en___localFiles___publicURL'
  | 'data___text_en___localFiles___id'
  | 'data___text_en___localFiles___children'
  ...
  | 'data___notes___localFiles'
  | 'data___notes___localFiles___sourceInstanceName'
  | 'data___notes___localFiles___absolutePath'
  | 'data___notes___localFiles___relativePath'
  | 'data___notes___localFiles___extension'
  | 'data___notes___localFiles___size'
  | 'data___notes___localFiles___prettySize'
  | 'data___notes___localFiles___modifiedTime'
  | 'data___notes___localFiles___accessTime'
  | 'data___notes___localFiles___changeTime'
  | 'data___notes___localFiles___birthTime'
  | 'data___notes___localFiles___root'
  | 'data___notes___localFiles___dir'
  | 'data___notes___localFiles___base'
  | 'data___notes___localFiles___ext'
  | 'data___notes___localFiles___name'
  | 'data___notes___localFiles___relativeDirectory'
  | 'data___notes___localFiles___dev'
  | 'data___notes___localFiles___mode'
  | 'data___notes___localFiles___nlink'
  | 'data___notes___localFiles___uid'
  | 'data___notes___localFiles___gid'
  | 'data___notes___localFiles___rdev'
  | 'data___notes___localFiles___ino'
  | 'data___notes___localFiles___atimeMs'
  | 'data___notes___localFiles___mtimeMs'
  | 'data___notes___localFiles___ctimeMs'
  | 'data___notes___localFiles___atime'
  | 'data___notes___localFiles___mtime'
  | 'data___notes___localFiles___ctime'
  | 'data___notes___localFiles___birthtime'
  | 'data___notes___localFiles___birthtimeMs'
  | 'data___notes___localFiles___blksize'
  | 'data___notes___localFiles___blocks'
  | 'data___notes___localFiles___url'
  | 'data___notes___localFiles___publicURL'
  | 'data___notes___localFiles___id'
  | 'data___notes___localFiles___children'
  ...
  | 'data___roles___parent___children'
  | 'data___roles___children'
  | 'data___roles___children___id'
  | 'data___roles___children___children'
  | 'data___roles___internal___content'
  | 'data___roles___internal___contentDigest'
  | 'data___roles___internal___description'
  | 'data___roles___internal___fieldOwners'
  | 'data___roles___internal___ignoreType'
  | 'data___roles___internal___mediaType'
  | 'data___roles___internal___owner'
  | 'data___roles___internal___type'
  ...
  | 'data___location___parent___children'
  | 'data___location___children'
  | 'data___location___children___id'
  | 'data___location___children___children'
  | 'data___location___internal___content'
  | 'data___location___internal___contentDigest'
  | 'data___location___internal___description'
  | 'data___location___internal___fieldOwners'
  | 'data___location___internal___ignoreType'
  | 'data___location___internal___mediaType'
  | 'data___location___internal___owner'
  | 'data___location___internal___type'
...
export type Unnamed_2_Query = { work: { nodes: Array<{ data?: Maybe<(
        ...
        & { notes?: Maybe<{ childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'html'>> }>, roles?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'title'>> }>>>, location?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'title'>> }>>>, organisation?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'title'>> }>>>, tags?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'name'>> }>>> }
...
export type Unnamed_4_Query = { allAirtable: { nodes: Array<{ data?: Maybe<(
        Pick<AirtableData, 'title' | 'link' | 'date' | 'featured' | 'slug'>
...
export type Unnamed_5_Query = { allAirtable: { nodes: Array<{ data?: Maybe<(
        Pick<AirtableData, 'title' | 'date' | 'slug' | 'slides'>
        & { notes?: Maybe<{ childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'excerpt'>> }>, organisation?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'title'>> }>>>, tags?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'name'>> }>>> }
      )> }> } };
...
export type Unnamed_7_Query = { airtable?: Maybe<{ data?: Maybe<(
      Pick<AirtableData, 'title' | 'link' | 'date'>
      & { organisation?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'title'>> }>>>, tags?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'name'>> }>>>, attachments?: Maybe<{ localFiles?: Maybe<Array<Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>>> }> }
    )> }> };
...
export type Unnamed_8_Query = { airtable?: Maybe<(
    ...
    & { data?: Maybe<(
      ...
      & { text_en?: Maybe<{ childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'html'>> }>, organisation?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'title'>> }>>>, tags?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'name'>> }>>> }
    )> }
  )> };
...
export type Unnamed_9_Query = { tag?: Maybe<{ data?: Maybe<(
      ...
      Pick<Airtable, 'table'>
      & { data?: Maybe<Pick<AirtableData, 'title' | 'date' | 'slug'>> }
    )> }, writing: { nodes: Array<(
      Pick<Airtable, 'table'>
...
export type Unnamed_10_Query = { airtable?: Maybe<{ data?: Maybe<(
      Pick<AirtableData, 'title' | 'date' | 'link' | 'recording' | 'slides'>
      & { notes?: Maybe<{ childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'html'>> }>, organisation?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'title'>> }>>>, tags?: Maybe<Array<Maybe<{ data?: Maybe<Pick<AirtableData, 'name'>> }>>> }
    )> }> };
